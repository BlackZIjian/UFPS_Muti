...
public class vp_AIBodyAnimator : MonoBehaviour
{
	...
	protected virtual void InitMaxSpeeds()
	{
		...
		{
			// get max speed of first vp_AIController that we can find under the ancestor
			vp_AIController controller = Transform.root.GetComponentInChildren<vp_AIController>();
